...
export function Sidebar() {
  // 1. Extraemos familiaActual para verificar su estado
  const { usuarioActual, pestanaActiva, setPestanaActiva, familiaActual } = useApp();
  ...
  // Variable auxiliar: Si NO es jefe de familia, siempre ve los módulos. Si lo es, debe estar aprobado.
          ...
          {esJefeFamilia && !estaAprobado && (
            <div className="mx-3 mt-3 p-3 bg-red-500/10 border border-red-500/20 rounded-xl flex items-start gap-2">
              ...
              <p className="text-[10px] text-red-300 font-semibold leading-relaxed">
                Módulos comunitarios bloqueados hasta que tu censo sea aprobado por la directiva.
              </p>
            </div>
          )}
